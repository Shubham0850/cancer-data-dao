...
const PurchasedSecrets: FC = () => {
  ...
  return <>
    ...
    {myPurchasedSecrets.length > 0 ?
      ...
      </div> : <p className="text-base font-mono font-light dark:text-gray-300 ml-2">You have not unlocked any content yet. Sign in and purchase some content to see it decrypted!</p>}
  </>
}
