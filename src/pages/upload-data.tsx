    ...
    <>
      ...
      <div className="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <h1 className="text-6xl font-mono font-light">Upload Data</h1>

        
            <p className="text-lg font-mono font-light ml-2">Encrypt & upload your content and set your price for people to see it!</p>
